...
*/
$coverageHtmlField = new atoum\report\fields\runner\coverage\html('knt-cms', 'tests/units/reports/coverage/html');

/*
Please replace in next line http://url/of/web/site by the root url of your code coverage web site.
*/
$coverageHtmlField->setRootUrl('http://localhost:8080/tests/units/reports/coverage/html');
...
Please replace in next line /path/to/destination/directory by your destination directory path for html files.
*/
$coverageTreemapField = new atoum\report\fields\runner\coverage\treemap('knt-cms', 'tests/units/reports/coverage/treemap');

/*
Please replace in next line http://url/of/treemap by the root url of your treemap web site.
*/
$coverageTreemapField
	->setTreemapUrl('http://localhost:8080/tests/units/reports/coverage/treemap')
